...
export default function AdminDataDelete() {
  const [currentAdminData, setCurrentAdminData] = useAtom(
    currentDetailAdminAtom,
  );
  ...
  return (
    <div>
      <h2 className="mb-5 text-lg font-bold">
        {" "}
        Delete : {currentAdminData?.first_name} {currentAdminData?.middle_name}{" "}
        {currentAdminData?.last_name} ({currentAdminData?.username})
      </h2>
