...
export default function PublicProductDetail({
  ...
  const [lastUpdate, setLasUpdate] = useState<string | Date | null>(null);
  ...
  function handleStockSelect(
    ...
    if (product && product.StoreHasProduct) {
      ...
      setLasUpdate(product?.StoreHasProduct[e?.id!]?.updatedAt ?? "");
    }
  }
                ...
                <div className="mt-2 inline-flex w-full justify-between">
                  ...
                  <p className="inline-flex items-center">
                    {isLoading ? (
                      ...
                      <>
                        {stock}
                        <input type="hidden" name="stock" defaultValue={stock!} />
                      </>
                    )}
                  </p>
                </div>
